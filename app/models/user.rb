...
# 3. If password confirmation is present, it will make sure it is equal to password.
# 4. Password length should be less than or equal to 72 characters.
# 5. It will hash the password using the BCrypt Gem and store the hash digest in the password_digest field.
